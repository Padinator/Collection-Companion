...
class DatabseMsApplicationTests {
    ...
    class SammlungTest {
        ...
        void testToJSON1() {
            for (Map.Entry<String, Sammlung> entry : generateAllPossibleSammlungen("test collection",
                    categories, visibilities, new LinkedList<>(), new LinkedList<>()).entrySet()) {
        ...
        void testToJSON2() {
            for (Map.Entry<String, Sammlung> entry : generateAllPossibleSammlungen("test collection",
                    categories, visibilities, List.of("123", "456", "789"), new LinkedList<>()).entrySet()) {
                Sammlung result = entry.getValue();
                String expected = entry.getKey();
    ...
    class UserTest {
        ...
        /**
         * Tests "toJSON()" method with a user with Sammlungen but without friends and without friend requests and
         * without evaluations
         */
        @Test
        void testToJSON1() {
            Map<String, Sammlung> sammlungen = generateAllPossibleSammlungen("test collection", categories,
                    visibilities, new LinkedList<>(), new LinkedList<>());
        ...
        /**
         * Tests "toJSON()" method with a user with Sammlungen and friends and without friend requests and without
         * evaluations
         */
        @Test
        void testToJSON2() {
        ...
        /**
         * Tests "toJSON()" method with a user without Sammlungen and without friends and without friend requests and
         * without evaluations
         */
        @Test
        void testToJSON3() {
        ...
        /**
         * Tests "toJSON()" method with a user without Sammlungen but with friends and without friend requests and
         * without evaluations
         */
        @Test
        void testToJSON4() {
        ...
        /**
         * Tests "toJSON()" method with a user with Sammlungen but with friends and with friend requests and without
         * evaluations
         */
        @Test
        void testToJSON5() {
    ...
    private Map<String, Sammlung> generateAllPossibleSammlungen(String sammlungName, List<String> categories, List<String> visibilities, List<String> collectionIds, List<Pair<String, Boolean>> evaluations) {
        ...
        if (evaluations.isEmpty())
            ...
            evaluationString = "[ \"" + String.join("\", \"", evaluations.stream()
        ...
        for (String category : categories)
            for (String visibility : visibilities)
                sammlungen.put("{ \"name\": \"" + sammlungName + "\", \"visibility\": \"" + visibility
                        ...
                        + ", \"evaluations\": " + evaluationString + " }",
                        new Sammlung(sammlungName, visibility, category, new LinkedList<>(collectionIds), new LinkedList<>(evaluations)));
